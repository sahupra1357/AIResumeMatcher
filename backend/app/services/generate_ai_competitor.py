...
from app.services.skill_comparison import SkillComparison
...
if __name__ == "__main__":
    # Example usage - replace with actual resume and job description
    sample_resume = "Sample resume text here"
    sample_jd = "Sample job description here"

    ai_competitor = AICompetitor(sample_resume, sample_jd, 30)
